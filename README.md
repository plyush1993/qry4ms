...
The [Shiny App](https://shiny.posit.co/) for generating an individual .ms or .mgf file from user-provided MS spectra in MS1 & MS2 levels for a single compound. Spectra can be provided in .txt or pasted directly from the clipboard through e.g. [ElMaven](https://github.com/ElucidataInc/ElMaven). The obtained .ms and .mgf files are suitable for processing in [SIRIUS](https://bio.informatik.uni-jena.de/software/sirius/), .mgf - [NIST MS Search](https://chemdata.nist.gov/mass-spc/ms-search/), [MetaboScape](https://www.bruker.com/en/products-and-solutions/mass-spectrometry/ms-software/metaboscape.html). It is also possible to filter by precursor mass and relative abundance, which provides a tidy formatting for the search query in [GNPS](https://fasst.gnps2.org/fastsearch/), [MetaboAnalyst](https://dev.metaboanalyst.ca/MetaboAnalyst/upload/MS2UploadView.xhtml), [MassBank](https://massbank.eu/MassBank/search), [MS-FINDER](https://systemsomicslab.github.io/compms/msfinder/main.html) and [BUDDY](https://github.com/Philipbear/BUDDY_Metabolomics). Also, there is an option to build a mirror plot from the reference spectra.
